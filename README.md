...
![Task Sensei AWS Architecture]([docs/Task Sensei AWS Diagram.png](https://github.com/ZWieseDev/TaskSenseiOverview/blob/main/Task%20Sensei%20AWS%20Diagram.png))
